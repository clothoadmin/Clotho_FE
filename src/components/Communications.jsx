...
import { sendReply, getAllRepliedMessages, getAllUnrepliedMessages, getMessageById, deleteMessage  } from '../service/commAPI';
...
export const Communications = () => {
    ...
    useEffect(()=>{
      const fetchRepliedMessages = async ()=>{
        try{
          const response = await getAllRepliedMessages(user.address);
      ...
      const fetchUnrepliedMessages = async ()=>{
        try{
          const response = await getAllUnrepliedMessages(user.address);
